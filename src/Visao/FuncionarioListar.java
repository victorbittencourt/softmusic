...
public class FuncionarioListar extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        tblFuncionario.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Cód. F.", "Cód. E.", "Nome", "CPF", "Cargo", "Chapa", "Salário", "Retirar"
            }
        ) {
            Class[] types = new Class [] {
                java.lang.Integer.class, java.lang.Integer.class, java.lang.String.class, java.lang.String.class, java.lang.String.class, java.lang.String.class, java.lang.Float.class, java.lang.Boolean.class
            };
        ...
        pnTblCliente.setViewportView(tblFuncionario);
        if (tblFuncionario.getColumnModel().getColumnCount() > 0) {
            tblFuncionario.getColumnModel().getColumn(0).setMaxWidth(45);
            tblFuncionario.getColumnModel().getColumn(1).setMaxWidth(45);
            tblFuncionario.getColumnModel().getColumn(7).setMaxWidth(40);
        }
        ...
        if (n == 0) {
            for (int i = 0; i < tblFuncionario.getRowCount(); i++) {
                Boolean chkDel = Boolean.valueOf(
                        tblFuncionario.getValueAt(i, 7).toString()
                );
                
                if (chkDel) {
                    int funcId = Integer.parseInt(
                            tblFuncionario.getValueAt(i, 0).toString()
                    );
                    
                    FuncionarioControle funcC = new FuncionarioControle();
                    
                    funcC.excluirFuncionarioMultiplo(funcId);
                }
            }
    ...
    private ArrayList<FuncionarioModelo> iniciaTabela() {
        int i;
        ...
        tblFuncionario.getColumnModel().getColumn(0).setPreferredWidth(2);
